...
from lib.models.bisenetv1_with_ghostaspp import BiSeNetV1_ghostaspp
...
parser.add_argument('--model', type=str,
                    default='bisenetv1_ghostaspp', help='model name')
...
if __name__ == "__main__":
    ...
    if args.model == 'ddrnet':
        ...
        losses = [OhemCrossEntropyLoss(), OhemCrossEntropyLoss(), OhemCrossEntropyLoss()]
        loss_weights = [1, 1, 1]
    elif args.model == 'bisenetv1_ghostaspp':
        model = BiSeNetV1_ghostaspp(args.num_classes)
        losses = [OhemCrossEntropyLoss(), OhemCrossEntropyLoss(), OhemCrossEntropyLoss()]
        loss_weights = [1, 1, 1]
