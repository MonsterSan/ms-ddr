...
class AFF(nn.Module):
    def __init__(self, channels=64, r=4):
        ...
        self.conv = nn.Conv2d(256,128, kernel_size=1,stride=1,padding=0,bias=False)
    ...
    def forward(self, x, residual):
        ...
        xo = self.relu(self.bn(self.conv(xo)))
        return xo
...
class BiSeNetV1_noarm_global2taspp_ffm2affconv(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_noarm_global2taspp_ffm2affconv, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
        self.aff = AFF(128)
...
if __name__ == "__main__":
    net = BiSeNetV1_noarm_global2taspp_ffm2affconv(2)
    net.cuda()
    net.eval()
