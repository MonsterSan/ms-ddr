...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.attention = Attention_block(128,512,128)
        # l x
    ...
    def forward(self, x):
        ...
        feat32 = self.attention(feat8,feat32)
...
class BiSeNetV1_noag_attention(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_noag_attention, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
class Attention_block(nn.Module):
    def __init__(self, F_g, F_l, F_int):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.down = nn.AdaptiveAvgPool2d(16)
...
if __name__ == "__main__":
    net = BiSeNetV1_noag_attention(2)
    net.cuda()
    net.eval()
