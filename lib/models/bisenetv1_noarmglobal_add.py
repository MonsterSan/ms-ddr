...
class BiSeNetV1_noarmglobal_add(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_noarmglobal_add, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
        self.ffm = FeatureFusionModule(128, 256)
...
if __name__ == "__main__":
    net = BiSeNetV1_noarmglobal_add(2)
    net.cuda()
    net.eval()
