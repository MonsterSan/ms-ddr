...
class BiSeNetV1_noarm_global2taspp_ffm2aff(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_noarm_global2taspp_ffm2aff, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
        self.aff = AFF(128)
...
if __name__ == "__main__":
    net = BiSeNetV1_noarm_global2taspp_ffm2aff(2)
    net.cuda()
    net.eval()
