...
class CaS(nn.Module):
    ...
    def forward(self, feat32, feat_sp):
        ...
        return feat_sp + self.arm(feat32_up + feat_sp)
...
class BiSeNetV1_noag_CaS(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_noag_CaS, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
